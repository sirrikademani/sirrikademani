...
| [Santander Customer Satisfaction Prediction](https://github.com/sirrikademani/Santander-Customer-Satisfaction-Prediction) | <img src="./images/SANTANDER.PNG" alt="Project Image" style="max-width: 100%;" /><br/>Performed exploratory data analysis [EDA] and devised decision tree model to predict the satisfaction of customers by training high volume of 76K rows of training data. |<img src="./images/jupyter.png" alt="Jupyter logo" style="max-width: 100%;" /> | 
